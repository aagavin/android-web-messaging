...
public class MainActivity extends Activity {
    ...
    public void getInfo(View view) {
        ...
        try {
            ...
            String origineLatitude;
            String origineLongitude;
              do {//get geocodes of start point
                geoCodes = new Geocoder(this, Locale.getDefault()).getFromLocationName(startName, 5);
                  ...
                  origineLatitude = String.valueOf(geoCodes.get(0).getLatitude());
                  origineLongitude = String.valueOf(geoCodes.get(0).getLongitude());
            ...
            //origineLatitude = URLEncoder.encode("43.7850417", "UTF-8"); // 941 Progress Avenue
            //origineLongitude = URLEncoder.encode("-79.2270519", "UTF-8");
            ...
            Log.i("encodingerror",e.getMessage());
        }
        catch(IOException e)
        {
            Log.i("geocode error",e.getMessage());
    ...
    public String readJSONFeed(String URL) {
        ...
        try {
            ...
            Log.i("readJSONFeed", e.getLocalizedMessage());
        }
